...
<head>
    ...
    <?php
        ...
        $comID = $_POST['searchID'];
        $q1 = "SELECT * FROM computer WHERE comID = '$comID'";
...
<body>
    <div>
        ...
        <button style="width: fit-content; height: fit-content; margin-right: 10px;" onclick="location.href='computerList.php'">back</button>
        ...
        <table border="1">
            ...
            <?php
                ...
                { echo "<script>alert('No Computer with such ID');
